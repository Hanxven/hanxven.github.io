...
const vueAppRootContainer = "#fashion-center";
...
const revive_payload_client_VFjmc6LYFW = /* @__PURE__ */ defineNuxtPlugin({
...
const unheadPlugins = [];
const unhead_3V455NE7A2 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/games/minesweeper",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/tools/hero-sequence",
...
const layouts = {};
const prefetch_client_zDh124ioFz = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:prefetch",
  setup(nuxtApp) {
    const router = useRouter();
...
const chunk_reload_client_UFN6vMuXen = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  revive_payload_client_VFjmc6LYFW,
  unhead_3V455NE7A2,
  plugin,
  components_plugin_KR1HBZs4kY,
  prefetch_client_zDh124ioFz,
  chunk_reload_client_UFN6vMuXen,
  naive_ui_cjnU5TlW5h
];
